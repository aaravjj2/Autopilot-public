...
- Name: navigation.spec.ts >> Navigation >> landing page has terminal button
...
Locator: getByRole('link', { name: /Enter Terminal/ })
Expected: visible
Timeout: 5000ms
