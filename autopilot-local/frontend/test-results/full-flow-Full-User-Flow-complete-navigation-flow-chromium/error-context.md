...
- complementary:
  ...
  - navigation:
    ...
    - link "Settings":
      ...
      - img
      - text: Settings
  - text: API 9995msWS 18msArb — WS live
- banner:
...
- main:
  ...
  - text: Real-time portfolio · Engine RUNNING · 11:28:10 PM
  - button "Refresh Cache"
  - text: LIVE Portfolio $146,874.43 0.01% today Buying Power $585,001.00 Cash $144,818.18 Positions 1 1 profitable Signals 0 0 high conviction Arb Active 0 — Real-time P&L Unrealized $39.99 Daily P&L $10.44 Position value $2,056.25 Cash $144,818.18 Equity Curve · 30D Risk snapshot 0.0% Daily 1 Open Watchlist
  - button "+ Add"
  - table:
    - rowgroup:
...
- contentinfo: "WS: connected API: — Data age: 0s Updated: 11:28:10 PM APEX Terminal"
- alert
```
