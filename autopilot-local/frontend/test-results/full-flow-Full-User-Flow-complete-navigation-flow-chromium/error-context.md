...
- complementary:
  ...
  - navigation:
    ...
    - link "Settings":
      ...
      - img
      - text: Settings
  - text: API 8205msWS 5msArb 943ms WS live
- banner:
...
- main:
  ...
  - text: Real-time portfolio · Engine RUNNING · 12:35:22 AM
  - button "Refresh Cache"
  - text: LIVE Portfolio $146,874.96 0.01% today Buying Power $585,001.00 Cash $144,818.18 Positions 1 1 profitable Signals 0 0 high conviction Arb Active 0 — Real-time P&L Unrealized $40.52 Daily P&L $10.97 Position value $2,056.78 Cash $144,818.18 Equity Curve · 30D Risk snapshot 0.0% Daily 1 Open Watchlist
  - button "+ Add"
  - table:
    - rowgroup:
...
- contentinfo: "WS: connected API: — Data age: 0s Updated: 12:35:22 AM APEX Terminal"
- alert
```
