...
- Name: full-terminal.spec.ts >> Every sidebar tab >> Fund loads via direct URL
...
- generic [ref=e2]:
  ...
  - main [ref=e133]:
    - generic [ref=e134]:
      - generic [ref=e135]:
        - heading "Fund Admin" [level=2] [ref=e136]
        - generic [ref=e137]: Multi-tenant stubs · tear-sheets · copy-scale (Week 10)
      - button "Download PDF" [ref=e139]
    - generic [ref=e140]:
      - generic [ref=e142]: Tenant layer
      - paragraph [ref=e143]: Paper-only fund layer. Configure POSTGRES_URL for multi-tenant mode.
  - contentinfo [ref=e144]:
    - generic [ref=e145]: "WS: disconnected"
    - generic [ref=e146]: "API: —"
    - generic [ref=e147]: "Data age: 0s"
    - text: APEX Terminal
```
