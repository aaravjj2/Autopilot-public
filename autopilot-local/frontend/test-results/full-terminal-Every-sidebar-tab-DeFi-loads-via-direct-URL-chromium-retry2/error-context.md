...
- Name: full-terminal.spec.ts >> Every sidebar tab >> DeFi loads via direct URL
...
- generic [ref=e2]:
  ...
  - main [ref=e133]:
    - generic [ref=e135]:
      - heading "DeFi Treasury" [level=2] [ref=e136]
      - generic [ref=e137]: Aave sweep · 1inch routing · MEV guard (paper)
    - paragraph [ref=e138]: Loading treasury status…
  - contentinfo [ref=e139]:
    - generic [ref=e140]: "WS: disconnected"
    - generic [ref=e141]: "API: —"
    - generic [ref=e142]: "Data age: 0s"
    - text: APEX Terminal
```
