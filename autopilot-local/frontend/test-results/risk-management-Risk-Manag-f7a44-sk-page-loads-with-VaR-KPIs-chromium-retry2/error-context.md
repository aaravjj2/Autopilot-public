...
- Name: risk-management.spec.ts >> Risk Management (Week 6) >> risk page loads with VaR KPIs
- Location: tests/e2e/risk-management.spec.ts:5:7
...
- generic [ref=e2]:
  ...
  - main [ref=e133]:
    - generic [ref=e134]:
      - generic [ref=e135]:
        - heading "Risk Management" [level=2] [ref=e136]
        - generic [ref=e137]: Monte Carlo VaR · CFTC limits · VIX-dampened Kelly sizing
      - button "↻ Refresh" [ref=e139]
    - paragraph [ref=e140]: Loading risk metrics…
  - contentinfo [ref=e141]:
    - generic [ref=e142]: "WS: disconnected"
    - generic [ref=e143]: "API: —"
    - generic [ref=e144]: "Data age: 0s"
    - text: APEX Terminal
```
