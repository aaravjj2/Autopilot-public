...
- Name: full-terminal.spec.ts >> Every sidebar tab >> Kalshi loads via direct URL
...
- generic [ref=e2]:
  ...
  - main [ref=e133]:
    - generic [ref=e134]:
      - generic [ref=e135]:
        - heading "Kalshi Book" [level=2] [ref=e136]
        - generic [ref=e137]: Event-contract paper positions · cross-venue arb with Polymarket (not copy trading)
      - generic [ref=e138]:
        - generic [ref=e139]: Agents…
        - button "Run both agents" [ref=e140]
        - button "Paper top" [disabled] [ref=e141]
        - button "…" [disabled] [ref=e142]
    - generic [ref=e143]: Internal paper only — enable KALSHI_DEMO_TRADING_ENABLED in .env to post orders to the Kalshi demo API.
    - paragraph [ref=e144]: Loading Kalshi book…
