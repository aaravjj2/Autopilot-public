...
- Name: full-terminal.spec.ts >> Polymarket features >> Sync from engine button
- Location: tests/e2e/full-terminal.spec.ts:186:7
...
- generic [ref=e2]:
  ...
  - main [ref=e133]:
    - generic [ref=e134]:
      - generic [ref=e135]:
        - heading "Polymarket Book" [level=2] [ref=e136]
        - generic [ref=e137]: Prediction-market paper book · arb NO legs (not Alpaca copy trading)
      - generic [ref=e138]:
        - generic [ref=e139]: APEX audit
        - button "↻ Refresh" [disabled] [ref=e140]
        - button "Run both agents" [ref=e141]
        - button "Sync copy-trading DB" [ref=e142]
    - generic [ref=e143]: Paper simulation — Polymarket legs are simulated in APEX; not live CLOB orders unless you wire live trading.
    - paragraph [ref=e144]: Loading Polymarket data…
  - contentinfo [ref=e145]:
    - generic [ref=e146]: "WS: disconnected"
    - generic [ref=e147]: "API: —"
    - generic [ref=e148]: "Data age: 0s"
    - text: APEX Terminal
```
