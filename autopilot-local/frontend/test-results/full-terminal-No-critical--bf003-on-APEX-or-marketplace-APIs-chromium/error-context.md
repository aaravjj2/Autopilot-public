...
- Name: full-terminal.spec.ts >> No critical API failures in browser >> dashboard does not log 404 on APEX or marketplace APIs
- Location: tests/e2e/full-terminal.spec.ts:234:7
