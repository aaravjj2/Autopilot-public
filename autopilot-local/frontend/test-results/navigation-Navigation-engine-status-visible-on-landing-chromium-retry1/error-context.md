...
- Name: navigation.spec.ts >> Navigation >> engine status visible on landing
...
Locator: getByText(/Engine online/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/Engine online/i)
    2 × waiting for" http://127.0.0.1:3000/" navigation to finish...
