...
- Name: full-terminal.spec.ts >> Live Feed features >> filter input and limit select
- Location: tests/e2e/full-terminal.spec.ts:152:7
...
- generic [ref=e2]:
  ...
  - main [ref=e133]:
    - generic [ref=e134]:
      - generic [ref=e135]:
        - heading "Live Feed" [level=2] [ref=e136]
        - generic [ref=e137]: APEX audit log · proposals, risk gates, arb fills
      - generic [ref=e139]: 0 events · poll
    - generic [ref=e140]:
      - generic [ref=e141]:
        - button "All" [ref=e142]
        - button "ARB" [ref=e143]
        - button "GATE" [ref=e144]
        - button "RISK" [ref=e145]
        - button "PROPOSAL" [ref=e146]
        - button "ORDER" [ref=e147]
      - generic [ref=e148]:
        - textbox "Filter type or symbol…" [ref=e149]
        - combobox [ref=e150]:
          - option "50"
          - option "100"
          - option "200" [selected]
      - paragraph [ref=e151]: Loading audit stream…
  - contentinfo [ref=e152]:
    - generic [ref=e153]: "WS: disconnected"
    - generic [ref=e154]: "API: —"
    - generic [ref=e155]: "Data age: 0s"
    - text: APEX Terminal
```
