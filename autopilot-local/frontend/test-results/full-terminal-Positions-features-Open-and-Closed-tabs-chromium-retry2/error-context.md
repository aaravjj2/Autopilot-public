...
- Name: full-terminal.spec.ts >> Positions features >> Open and Closed tabs
- Location: tests/e2e/full-terminal.spec.ts:111:7
...
Call log:
  - navigating to "http://127.0.0.1:3000/dashboard/positions", waiting until "load"
