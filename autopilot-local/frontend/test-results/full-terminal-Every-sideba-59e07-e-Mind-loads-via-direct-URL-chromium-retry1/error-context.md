...
- Name: full-terminal.spec.ts >> Every sidebar tab >> Hive-Mind loads via direct URL
...
- generic [ref=e2]:
  ...
  - main [ref=e133]:
    - generic [ref=e134]:
      - generic [ref=e135]:
        - heading "AI Hive-Mind" [level=2] [ref=e136]
        - generic [ref=e137]: Six-agent committee votes on arb proposals (not copy-trading pilots)
      - button "Run vote" [ref=e139]
    - generic [ref=e140]:
      - generic [ref=e142]: Active proposal
      - paragraph [ref=e143]: Loading proposal…
    - generic [ref=e144]:
      - generic [ref=e146]: Committee log
      - paragraph [ref=e147]: Run consensus on the selected arb proposal
  - contentinfo [ref=e148]:
    - generic [ref=e149]: "WS: disconnected"
    - generic [ref=e150]: "API: —"
    - generic [ref=e151]: "Data age: 0s"
    - text: APEX Terminal
```
