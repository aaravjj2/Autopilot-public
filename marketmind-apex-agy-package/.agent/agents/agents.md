...
- Stream Claude `claude-sonnet-4-20250514` via `anthropic.AsyncAnthropic().messages.stream()`
...
**Responsibilities:**
- Write pytest tests for `ArbEngine`, `SettlementAuditor`, `ArbAnalystPanel` (mock Anthropic API)
